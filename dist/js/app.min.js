...
const lazyBackground = new lazyload_min({
...
;// CONCATENATED MODULE: ./src/js/files/scroll/aos.js
...
;// CONCATENATED MODULE: ./src/js/files/common.js
...
formFieldsInit({ viewPass: false, autoHeight: true });
